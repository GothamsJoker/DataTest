...
import com.dylan.ApplicationBinder;
...
public class CommentServiceImplTest extends JerseyTest {
    ...
    public void it_posts_comment() {
        Comment c = new Comment("dylan", "eat my ass", 1, System.currentTimeMillis());
        ...
        assertEquals("Posted comment should match what we submitted", c, posted);
    }
}
